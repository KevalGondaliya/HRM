...
function ClaimsReport({navigation}) {
  ...
  const [openClaimType, setOpenClaimType] = useState(false);
  const [claimTypeArr, setClaimTypeArr] = useState(dropDownData);
  ...
  const submitBtn = () => {
    if (
      ...
      setIsError(false);
      clearForm();
      navigation.navigate('ViewClaimsReport');
    } else {
      setIsError(true);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.containerView}>
      ...
      <KeyboardAwareScrollView
        ...
        <ScreenDescription
          description1={`Download an excel file of all employees' claims.`}
        ...
        <ReportDetails
          ...
          openClaimType={openClaimType}
          claimTypeArr={claimTypeArr}
          setOpenClaimType={setOpenClaimType}
          setClaimTypeValue={setClaimTypeValue}
          setClaimTypeArr={setClaimTypeArr}
        />
