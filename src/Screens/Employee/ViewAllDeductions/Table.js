  ...
  const ListHeader = () => {
    return (
      <View style={[styles.headerStyle, styles.headerMainView]}>
        ...
        <Text style={styles.userNameTxt}>Deduction Date</Text>

        <Text style={styles.userNameTxt}>Description</Text>

        {is400 && <Text style={styles.userNameTxt}>Amount</Text>}
        {is500 && <Text style={styles.userNameTxt}>Comments</Text>}
        {is600 && (
          <Fragment>
    ...
    return (
      <View
        ...
        <Text numberOfLines={1} style={[styles.userNameTxt, styles.sBlack]}>
          {moment(item?.deduct_type?.createdAt).format('YYYY MMM DD')}
        </Text>
