      ...
      children={
        <View style={styles.containerView}>
          ...
          <View style={styles.emailView}>
            <Text style={styles.userNameTxt}>Check Out</Text>
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  marginRight: 0,
                  borderWidth: props.isError && props.checkOut == '' ? 2 : 0,
                  borderColor:
                    props.isError && props.checkOut == '' ? 'red' : null,
              ...
              <Text style={styles.checkinTime}>
                {props.checkOut
                  ? moment(props.checkOut, 'HH:mm:ss').format('LT')
                  : ''}
              </Text>
            </TouchableOpacity>
          </View>
